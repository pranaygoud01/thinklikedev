...
const About = () => {
  return (
    <div className="min-h-screen flex gap-10 bg-white text-black px-10 py-10 max-w-8xl mx-auto">
      {/* Page Title */}
      <div className="w-7/12">
      <h1 className="text-4xl font-bold mb-8">About ThinkLikeDev</h1>
      ...
      <div className="w-5/12 h-[80vh] sticky top-25 bg-center bg-no-repeat bg-cover"
      style={{backgroundImage:"url('https://images.unsplash.com/photo-1681066470612-36021f8da3d6?q=80&w=688&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')"}}>
        </div>
    </div>
  );
};
